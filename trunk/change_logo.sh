...
#logo位置：/opt/rt-n56u/trunk/user/www/n56u_ribbon_fixed/bootstrap/img/logo/
#脚本位置：/opt/rt-n56u/change_logo.sh
#本地使用方法：在编译命令之前，执行`sh change_logo.sh 路由器型号`


LOGO_DIR=/opt/rt-n56u/trunk/user/www/n56u_ribbon_fixed/bootstrap/img
ROUTER=$1
